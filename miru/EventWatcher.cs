...
{
    public delegate void FileEventHandler(string name, ulong processId, string account);
    public delegate void MoveEventHandler(string name, string oldName, ulong processId, string account);
        ...
        private void DeliverEvent(FileSystemEvent fileEvent, bool postponeDelivery)
        {
            switch (fileEvent.Type)
            {
                case EventType.Change:
                    OnChange?.Invoke(fileEvent.Filename, fileEvent.ProcessId, fileEvent.Account);
                    break;
                case EventType.Create:
                    OnCreate?.Invoke(fileEvent.Filename, fileEvent.ProcessId, fileEvent.Account);
                    break;
                case EventType.Delete:
                    OnDelete?.Invoke(fileEvent.Filename, fileEvent.ProcessId, fileEvent.Account);
                    break;
                case EventType.Move:
                    OnRenameOrMove?.Invoke(fileEvent.Filename, ((RenameOrMoveEvent) fileEvent).OldFilename, fileEvent.ProcessId, fileEvent.Account);
                    break;
                default:
                    break;
            }
